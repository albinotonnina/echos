...
- EchOS is security-sensitive — read [docs/SECURITY.md](docs/SECURITY.md) before touching auth, URL fetching, or storage
...
Plugins are the right place for new content sources. See [docs/PLUGINS.md](docs/PLUGINS.md) for the full guide. The short version:
