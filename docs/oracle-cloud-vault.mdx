...
description: "Secrets management with Oracle Cloud Vault."
---
...
<Note>You may need to create a Dynamic Group for your compute instance: go to **Identity & Security** → **Dynamic Groups** and create: `All instances in compartment <YOUR_COMPARTMENT_NAME>`.</Note>
