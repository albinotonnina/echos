---
title: "Releasing"
description: "How to cut a release and what CI does automatically."
---
...
# Update url + sha256 in this repo
# homebrew/echos.rb → url / sha256 lines

# Sync to the tap repo
cp homebrew/echos.rb /path/to/homebrew-echos/Formula/echos.rb
cd /path/to/homebrew-echos
git add Formula/echos.rb && git commit -m "echos v0.X.X" && git push origin main
```

See [homebrew/README.md](../homebrew/README.md) for the full step-by-step.
