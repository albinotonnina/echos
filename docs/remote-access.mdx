...
When EchOS runs on a VPS, the knowledge files live at `~/echos/knowledge/` on the server. This guide covers the main ways to access that directory from your local machine so you can open it in Obsidian, back it up, or work with the files directly.
