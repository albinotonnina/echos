...
This script will:
1. Install Node.js 20+ via [fnm](https://github.com/Schniz/fnm) if not present
...
- Feature toggles (Web UI, scheduler)
...
### Optional
- **Redis** — required only for background scheduler (digests, reminders, cron jobs)
