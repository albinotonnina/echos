...
export { restoreNoteTool, type RestoreNoteToolDeps } from './restore-note.js';
export { listTrashTool, type ListTrashToolDeps } from './list-trash.js';
...
export { listTodosTool, type ListTodosToolDeps } from './list-todos.js';
